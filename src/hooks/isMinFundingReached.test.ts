...
describe('isMinFundingReached', () => {
  it('should return true when current bidding is higher than min threshold', () => {
    const currentBidding = parseUnits('10', 10).toString()
    const minFundingThreshold = parseUnits('0.1', 10).toString()
  ...
  it('should return false when current bidding is lower than min threshold', () => {
    const currentBidding = parseUnits('1', 10).toString()
    const minFundingThreshold = parseUnits('10', 10).toString()
